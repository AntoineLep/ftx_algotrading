...
PAIRS_TO_TRACK = [
    ...
    "YFII-PERP", "OXY-PERP", "SOS-PERP", "LEO-PERP", "TRYB-PERP", "EDEN-PERP", "MNGO-PERP", "SECO-PERP", "CEL-PERP",
    "HOLY-PERP", "ASD-PERP", "MOB-PERP", "BTT-PERP", "MEDIA-PERP", "IOST-PERP", "JASMY-PERP", "GAL-PERP",
    "GST-PERP"
]
